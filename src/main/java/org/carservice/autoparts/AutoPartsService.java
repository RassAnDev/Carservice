...
/**
 * Create the org.carservice.autoparts.AutoPartsService class that acts as a middle layer
 * between persistence layer (repository) and controller layer.
 * This service class simply forwards the calls to an implementation of the org.carservice.autoparts.AutoPartsRepository interface.
